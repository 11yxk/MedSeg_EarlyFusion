...
class OverlapPatchEmbeddings(nn.Module):
    def __init__(self, img_size=224, patch_size=7, stride=4, padding=1, in_ch=6, dim=768):
        super().__init__()
...
class MiT(nn.Module):
    def __init__(self, image_size, dims, layers, token_mlp='mix_skip'):
        ...
        # patch_embed
        self.patch_embed1 = OverlapPatchEmbeddings(image_size, patch_sizes[0], strides[0], padding_sizes[0], 6, dims[0])
...
class MISSFormer(nn.Module):
    def __init__(self, num_classes=1, token_mlp_mode="mix_skip", encoder_pretrained=True):
        ...
        print('======================================')
        print('missformer_aug_text gene')
        print('======================================')
    ...
    def forward(self, data):
        ...
        return torch.sigmoid(tmp_0), gt, resized_tensor, gt_generate
